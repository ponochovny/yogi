		...
		>
			...
			<template v-else>
				<Popover>
					<PopoverTrigger>
						<div
							class="flex items-center gap-4 p-2 pr-3 rounded-full bg-white !text-zinc-900 shadow-md hover:bg-primary hover:!text-white transition-colors duration-500 border border-gray-300/40"
						>
							<NuxtImg
								provider="cloudinary"
...
import { searchLiveOfferingsLink } from '~/src/shared/utils/urls'
