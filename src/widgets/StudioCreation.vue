...
import timezones from '~/src/app/mocks/timeZones.json'
...
import _randomStudioData from '~/src/app/mocks/randomStudioData.json'
import type { IFeature, TMarker } from '~/src/app/types/map'
